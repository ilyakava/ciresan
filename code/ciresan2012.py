...
class Ciresan2012Column(object):
    def __init__(self, dataset='mnist.pkl.gz', nkerns=[32, 48], batch_size=1000, normalized_width=20, distortion=0, cuda_convnet=1):
        ...
        self.column_params = [dataset, nkerns, batch_size, normalized_width, distortion, cuda_convnet]
    ...
    def train_column(self, init_learning_rate=0.001, n_epochs=800):
        print '... training'
        ...
        dataset, nkerns, batch_size, normalized_width, distortion, cuda_convnet = self.column_params
...
def evaluate_ciresan2012(init_learning_rate=0.001, n_epochs=800,
    ...
    :param nkerns: number of kernels on each layer
    """
    column = Ciresan2012Column(dataset, nkerns, batch_size, normalized_width, distortion, cuda_convnet)
